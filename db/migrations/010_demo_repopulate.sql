-- ============================================================
-- Migration 010: Complete demo data repopulation
-- Force INSERT OR REPLACE all demo data
-- ============================================================
...
-- TEAMS (using correct IDs from 007)
...
-- USERS: Admin
INSERT OR REPLACE INTO users (id, club_id, email, password_hash, role, first_name, last_name, sport_codes, is_active)
VALUES (
  ...
  'ADMIN', 'Bogdan', 'Aliciuc',
  '["BASEBALL5","SOFTBALL"]', 1
);
...
-- USERS: Superadmin (admin@sporthub.ro)
INSERT OR REPLACE INTO users (id, club_id, email, password_hash, role, first_name, last_name, sport_codes, is_active)
VALUES (
  ...
  'admin@sporthub.ro',
  'pbkdf2:3a7f129e4bc50188d26af3449c71e82d:c1d211d6a5494f165c123a109b129d03fb03b61058d8a3dab18e37ae12e386b1',
  'SUPERADMIN', 'Admin', 'SportHub',
  '["BASEBALL5","SOFTBALL"]', 1
);

-- USERS: Superadmin (superadmin@sporthub.ro)
INSERT OR REPLACE INTO users (id, email, password_hash, role, first_name, last_name, sport_codes, is_active)
VALUES (
  'superadmin-002-0000-0000-0000-000000000001',
...
VALUES
  ...
  ('demo-tr-05','demo-club-0000-0000-0000-000000000001','demo-team-s01','Pregătire meci CN','2026-04-14T18:00','2026-04-14T20:00','Complexul Sportiv Titan, belgië','Pregătire meci CN','COMPLETED'),
...
INSERT OR IGNORE INTO match_selections (id, match_id, player_id, role, position_played) VALUES
  ('ms-m01-p01','demo-m01','demo-p01','STARTER','FIRST_BASE'),('ms-m01-p02','demo-m01','demo-p02','STARTER','SECOND_BASE'),
  ('ms-m01-p03','demo-m01','demo-p03','STARTER','THIRD_BASE'),('ms-m01-p04','demo-m01','demo-p04','STARTER','MIDFIELDER'),
  ('ms-m01-p05','demo-m01','demo-p05','STARTER','SHORTSTOP'),('ms-m01-p06','demo-m01','demo-p06','RESERVE','FIRST_BASE'),
  ('ms-m01-p07','demo-m01','demo-p07','RESERVE','SECOND_BASE'),
  ('ms-m04-p01','demo-m04','demo-p01','STARTER','FIRST_BASE'),('ms-m04-p02','demo-m04','demo-p02','STARTER','SECOND_BASE'),
  ('ms-m04-p03','demo-m04','demo-p03','STARTER','THIRD_BASE'),('ms-m04-p04','demo-m04','demo-p04','STARTER','MIDFIELDER'),
  ('ms-m04-p05','demo-m04','demo-p05','STARTER','SHORTSTOP'),('ms-m04-p09','demo-m04','demo-p09','RESERVE','SHORTSTOP'),
...
INSERT OR IGNORE INTO medical_visits (id, player_id, club_id, visit_date, valid_until, doctor_name, notes) VALUES
  ...
  ('demo-med-04','demo-p05','demo-club-0000-0000-0000-000000000001','2026-02-15','2026-04-30','Dr. Ana Ionescu','Entorsă gleznă grad I');
